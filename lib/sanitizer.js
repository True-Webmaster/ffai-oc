...
/**
 * Build a retry loop with exponential backoff.
 *
 * @param {function} fn             - Async function to retry: (attempt) => Promise<result>
 * @param {object}   [opts]
 * @param {number}   [opts.maxRetries]       - Max retry attempts (default: 3)
 * @param {number}   [opts.baseDelay]        - Base backoff delay ms (default: 100)
 * @param {number}   [opts.maxDelay]         - Max backoff delay ms (default: 2000)
 * @param {function} [opts.shouldRetry]      - (error, attempt) => boolean (default: always retry)
 * @param {function} [opts.onRetry]          - (error, attempt, delay) => void (optional callback)
...
module.exports = { sanitize, withRetry, ALLOWED_FIELDS, PROVIDER_STRIP };
